...
# custom setting for email FROM field
SERVER_EMAIL = 'info@openaction.it'
...
SECRET_KEY = r"g+p&4-qe*eiuzj^%ll^%h5ag35m^uh&f^77wrh!8uc!y@l02nk"
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'op_social_access.app.pipeline.redirect_to_form',
    'op_social_access.app.pipeline.username',
